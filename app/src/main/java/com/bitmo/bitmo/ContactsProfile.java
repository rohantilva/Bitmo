...
public class ContactsProfile extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            // add code to start new activity to launch edit profile page
            Intent intent = new Intent(this, EditContactProfile.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.action_delete) {
            // add code to delete a user from contacts
        }
